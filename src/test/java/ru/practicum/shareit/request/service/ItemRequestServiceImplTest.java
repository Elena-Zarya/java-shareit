...
class ItemRequestServiceImplTest {
    ...
    @Test
    void findAllItemRequest_whenFromIsNegative_shouldReturnValidationException() {
        int from = -2;
        int size = 1;
        assertThrows(ValidationException.class, () -> itemRequestService.findAllItemRequest(1L, from, size));
    }
}