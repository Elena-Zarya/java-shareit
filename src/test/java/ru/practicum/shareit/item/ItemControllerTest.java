...
class ItemControllerTest {
    ...
    @Test
    void createItem_nameIsEmpty_shouldReturnStatusBadRequest() throws Exception {
        long ownerId = 1L;

        mvc.perform(post("/items")
                        .content(mapper.writeValueAsString(new ItemDto(null, "", "description",
    ...
    @Test
    void createItem_descriptionIsEmpty_shouldReturnStatusBadRequest() throws Exception {
        long ownerId = 1L;

        mvc.perform(post("/items")
                        .content(mapper.writeValueAsString(new ItemDto(null, "name", null,
                                true, null, null, null, null, null)))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .header("X-Sharer-User-Id", ownerId)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    void createItem_availableIsEmpty_shouldReturnStatusBadRequest() throws Exception {
        long ownerId = 1L;

        mvc.perform(post("/items")
                        .content(mapper.writeValueAsString(new ItemDto(null, "name", "description",
