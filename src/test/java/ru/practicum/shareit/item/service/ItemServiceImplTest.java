...
class ItemServiceImplTest {
    ...
    @Test
    void getAllItemByUser_whenFromIsNegative_shouldReturnValidationException() {
        int from = -1;
        int size = 1;

        assertThrows(ValidationException.class, () -> itemService.getAllItemByUser(1L, from, size));
    }
    ...
    @Test
    void findItemsByText_whenSizeIsZero_shouldReturnValidationException() {
        String text = "description";
        int from = 0;
        int size = 0;

        assertThrows(ValidationException.class, () -> itemService.findItemsByText(text, from, size));
    }
