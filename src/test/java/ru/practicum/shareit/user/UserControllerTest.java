...
class UserControllerTest {
    ...
    @Test
    void createUser_whenNoEmail_shouldReturnStatusBadRequest() throws Exception {
        mvc.perform(post("/users")
                        .content(mapper.writeValueAsString(new UserDto(null, "olga", "")))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    @Test
    void createUser_whenInvalidEmail_shouldReturnStatusBadRequest() throws Exception {
        mvc.perform(post("/users")
                        .content(mapper.writeValueAsString(new UserDto(null, "olga", "e.com")))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isBadRequest());
    }
    ...
    @Test
    void createUser_whenNameIsEmpty_shouldReturnStatusBadRequest() throws Exception {
        mvc.perform(post("/users")
                        .content(mapper.writeValueAsString(new UserDto(null, "", "user@email.com")))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isBadRequest());
    }
